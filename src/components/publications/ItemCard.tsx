...
import type { Item, PublicationStatusBadgeProps } from '@/types/marketplace';
...
export const ItemCard = ({ item, selectable, selected, onToggle }: ItemCardProps) => (
  <div className="flex gap-3 border border-line bg-surface p-3">
    {selectable && (
      <input
        type="checkbox"
        checked={selected}
